# Generated by Django 4.2.8 on 2024-05-08 17:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(choices=[('Female', 'Female'), ('Male', 'Male')])),
                ('goal', models.IntegerField(choices=[(1, 'Maintenance'), (2, 'Muscle gain'), (3, 'Fat loss')])),
                ('allergies', models.IntegerField(choices=[(1, 'Celiac disease'), (2, 'Lactose intolerant'), (3, 'Seafood'), (4, 'Egg allergy'), (5, 'None')])),
            ],
            bases=('backend.user',),
        ),
        migrations.CreateModel(
