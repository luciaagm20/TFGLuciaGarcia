# Generated by Django 4.2.8 on 2024-06-12 16:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('allergy_type', models.CharField(choices=[('None', 'None'), ('Celiac disease', 'Celiac disease'), ('Lactose intolerant', 'Lactose intolerant'), ('Seafood', 'Seafood'), ('Egg allergy', 'Egg allergy')], default='None', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='DayOfWeek',
