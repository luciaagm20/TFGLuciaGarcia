# Generated by Django 4.2.8 on 2024-06-09 15:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='backend_users_groups', related_query_name='backend_user_group', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='backend_users_permissions', related_query_name='backend_user_permission', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
