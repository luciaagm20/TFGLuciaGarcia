...
SECRET_KEY = 'django-insecure-e#ibe4o*rj09!+zaque7q(@%t=gepiulu*6wg!!5$a0*j0=h2_'
...
WSGI_APPLICATION = 'healthyMenu.wsgi.application'
...
CELERY_BEAT_SCHEDULE = {
    'run_my_method_every_sunday': {
        'task': 'backend.tasks.create_weekly_menu',
        'schedule': {
            'type': 'crontab',
            'minute': 59,
            'hour': 23,
